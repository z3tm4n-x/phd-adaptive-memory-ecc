...
**[RE-CY62167-COVERAGE-THRESHOLD-01](RE-CY62167-COVERAGE-THRESHOLD-01.md) — приём постоянным RE подтверждён; численный результат не завершён из-за отсутствующего входа.** Один неизменный срез; восстановление нужного численного входа явно разрешено; выход — огибающая conditional write, требуемая граница физического покрытия и статус её обоснования из существующих сведений. Локальный SR-03 не переоткрывается. Новый общий поиск, сетка сравнений, контроллер и стенд не назначены. [Уточнение восстановления 2026-09-15](RE-CY62167-COVERAGE-THRESHOLD-01-INPUT-RECOVERY.md) фиксирует истечение исходного Actions-архива и разрешает только воспроизведение исторического transport с прежними исходниками/параметрами. Восстановление ещё не выполнено.
