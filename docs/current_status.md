...
[Решение и RE-CY62167-PHYSICAL-BRIDGE-REPAIR-02](research_gates/RE-CY62167-PHYSICAL-BRIDGE-REPAIR-02.md) подготовлены к передаче постоянному RE через пользователя; приём не подтверждён. Один следующий шаг: корректное включение событий, ожидание/all-check RMW-огибающая и исполняемая latch/write трасса, плюс связанные MINOR. Восстановление rate-файла, новая физическая калибровка и общий повтор исследования в задание не входят. После поставки — отдельный адресный SR исправленных утверждений. Issue №15 остаётся открыт; снятие старого overclaim и закрытие локального MAJOR не равны завершению физического моста.
