...
- [Позиция по завершению диссертации и одно следующее задание](docs/research_gates/DISSERTATION-COMPLETION-POSITION-01.md) уточнены PI. [Предварительный инженерный этап](experiments/RE-ENGINEERING-APPLICABILITY-01/REPORT.md) выполнен с использованием магистерского scrubber; крупная кампания и полное портирование не проводились.
