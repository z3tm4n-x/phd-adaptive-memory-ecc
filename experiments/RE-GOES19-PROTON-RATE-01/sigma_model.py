...
def sigma_hat(energy_mev, points: tuple[SigmaPoint, ...], model: str = "main_loglog") -> np.ndarray:
    """Return sigma_bit in cm^2/bit with explicit boundary assumptions.
    ...
    - inside support: log-log interpolation, with unresolved 29 MeV absent.

    Sensitivity models alter transparent choices one at a time.
    """
